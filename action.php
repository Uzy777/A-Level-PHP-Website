<?php
	...
	session_start();
	// A connection variable to the database of the system
  $conn = new mysqli("localhost","root","","EpicSystems2");
	// If an error occurs then display make the session die and show the user a message to let them know it failed
